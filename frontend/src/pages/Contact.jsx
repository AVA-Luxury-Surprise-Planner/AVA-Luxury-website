          ...
          <aside className="bg-primary p-8 text-cream dark:bg-ink md:p-12 lg:p-14">
            ...
            <div className="mt-10">
              ...
              <div className="flex gap-3">
                <a href="https://www.instagram.com/ava_luxury_surprise_planner/" target="_blank" rel="noopener noreferrer" className="grid h-11 w-11 place-items-center border border-gold/35 text-gold transition hover:bg-gold hover:text-primary" aria-label="Instagram">IG</a>
                <a href="https://web.facebook.com/AvaLuxurySurprisePlanner/?_rdc=1&_rdr#" target="_blank" rel="noopener noreferrer" className="grid h-11 w-11 place-items-center border border-gold/35 text-gold transition hover:bg-gold hover:text-primary" aria-label="Facebook">FB</a>
                <a href="https://www.linkedin.com/company/dolphin-foam/?originalSubdomain=et" target="_blank" rel="noopener noreferrer" className="grid h-11 w-11 place-items-center border border-gold/35 text-gold transition hover:bg-gold hover:text-primary" aria-label="LinkedIn">IN</a>
                <a href="https://www.tiktok.com/@avaluxurysurpriseplanner" target="_blank" rel="noopener noreferrer" className="grid h-11 w-11 place-items-center border border-gold/35 text-xs font-bold text-gold transition hover:bg-gold hover:text-primary" aria-label="TikTok">TT</a>
              </div>
            </div>
          </aside>
